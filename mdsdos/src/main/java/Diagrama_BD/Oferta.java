...
public class Oferta implements Serializable {
	...
	public static Oferta loadOfertaByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Oferta) session.load(Diagrama_BD.Oferta.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Oferta getOfertaByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Oferta) session.get(Diagrama_BD.Oferta.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Oferta loadOfertaByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Oferta) session.load(Diagrama_BD.Oferta.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Oferta getOfertaByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Oferta) session.get(Diagrama_BD.Oferta.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryOferta(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From diagrama_bd.Oferta as Oferta");
		if (condition != null)
	...
	public boolean deleteAndDissociate()throws PersistentException {
		try {
			if(getProducto() != null) {
				getProducto().ofertas.remove(this);
			}
	...
	private void this_setOwner(Object owner, int key) {
		if (key == Diagrama_BD.ORMConstants.KEY_OFERTA_PRODUCTO) {
	...
	@Id	
	@GeneratedValue(generator="DIAGRAMA_BD_OFERTA_ID_GENERATOR")	
	@org.hibernate.annotations.GenericGenerator(name="DIAGRAMA_BD_OFERTA_ID_GENERATOR", strategy="native")	
	private int id;
