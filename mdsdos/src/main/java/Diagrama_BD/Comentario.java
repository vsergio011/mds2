...
public class Comentario implements Serializable {
	...
	public static Comentario loadComentarioByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Comentario) session.load(Diagrama_BD.Comentario.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Comentario getComentarioByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Comentario) session.get(Diagrama_BD.Comentario.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Comentario loadComentarioByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Comentario) session.load(Diagrama_BD.Comentario.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Comentario getComentarioByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Comentario) session.get(Diagrama_BD.Comentario.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryComentario(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From diagrama_bd.Comentario as Comentario");
		if (condition != null)
	...
	public static Comentario createComentario() {
		return new Diagrama_BD.Comentario();
	}
	...
	public boolean deleteAndDissociate()throws PersistentException {
		try {
			if(getCibernauta() != null) {
				getCibernauta().comentario.remove(this);
			}
			
			if(getProducto() != null) {
				getProducto().comentarios.remove(this);
			}
	...
	private void this_setOwner(Object owner, int key) {
		if (key == Diagrama_BD.ORMConstants.KEY_COMENTARIO_PRODUCTO) {
			this.producto = (Diagrama_BD.Producto) owner;
		}
		
		else if (key == Diagrama_BD.ORMConstants.KEY_COMENTARIO_CIBERNAUTA) {
	...
	@Id	
	@GeneratedValue(generator="DIAGRAMA_BD_COMENTARIO_ID_GENERATOR")	
	@org.hibernate.annotations.GenericGenerator(name="DIAGRAMA_BD_COMENTARIO_ID_GENERATOR", strategy="native")	
	private int id;
