...
public class MensajeDAO {
	...
	public static Mensaje loadMensajeByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Mensaje) session.load(appventawebbd.Mensaje.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Mensaje getMensajeByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Mensaje) session.get(appventawebbd.Mensaje.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Mensaje loadMensajeByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Mensaje) session.load(appventawebbd.Mensaje.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Mensaje getMensajeByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Mensaje) session.get(appventawebbd.Mensaje.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryMensaje(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From appventawebbd.Mensaje as Mensaje");
		if (condition != null)
	...
	public static Mensaje createMensaje() {
		return new appventawebbd.Mensaje();
	}
	
	public static boolean save(appventawebbd.Mensaje mensaje) throws PersistentException {
		try {
			AppventawebPersistentManager.instance().saveObject(mensaje);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(appventawebbd.Mensaje mensaje) throws PersistentException {
		try {
			AppventawebPersistentManager.instance().deleteObject(mensaje);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(appventawebbd.Mensaje mensaje)throws PersistentException {
		try {
			if (mensaje.getOriginal() != null) {
				mensaje.getOriginal().respuestas.remove(mensaje);
			}
			
			if (mensaje.getDestinatario() != null) {
				mensaje.getDestinatario().mensajesRecibidos.remove(mensaje);
			}
			
			if (mensaje.getRemitente() != null) {
				mensaje.getRemitente().mensajesEnviados.remove(mensaje);
			}
			
			appventawebbd.Mensaje[] lRespuestass = mensaje.respuestas.toArray();
	...
	public static boolean deleteAndDissociate(appventawebbd.Mensaje mensaje, org.orm.PersistentSession session)throws PersistentException {
		try {
			if (mensaje.getOriginal() != null) {
				mensaje.getOriginal().respuestas.remove(mensaje);
			}
	...
	public static boolean refresh(appventawebbd.Mensaje mensaje) throws PersistentException {
		try {
			AppventawebPersistentManager.instance().getSession().refresh(mensaje);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(appventawebbd.Mensaje mensaje) throws PersistentException {
		try {
			AppventawebPersistentManager.instance().getSession().evict(mensaje);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
