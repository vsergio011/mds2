...
public class CategoriaDAO {
	...
	public static Categoria loadCategoriaByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Categoria) session.load(appventawebbd.Categoria.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Categoria getCategoriaByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Categoria) session.get(appventawebbd.Categoria.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Categoria loadCategoriaByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Categoria) session.load(appventawebbd.Categoria.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Categoria getCategoriaByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Categoria) session.get(appventawebbd.Categoria.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryCategoria(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From appventawebbd.Categoria as Categoria");
		if (condition != null)
	...
	public static Categoria createCategoria() {
		return new appventawebbd.Categoria();
	}
	
	public static boolean save(appventawebbd.Categoria categoria) throws PersistentException {
		try {
			AppventawebPersistentManager.instance().saveObject(categoria);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(appventawebbd.Categoria categoria) throws PersistentException {
		try {
			AppventawebPersistentManager.instance().deleteObject(categoria);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(appventawebbd.Categoria categoria)throws PersistentException {
		try {
			appventawebbd.Producto[] lProductoss = categoria.productos.toArray();
	...
	public static boolean deleteAndDissociate(appventawebbd.Categoria categoria, org.orm.PersistentSession session)throws PersistentException {
		try {
			appventawebbd.Producto[] lProductoss = categoria.productos.toArray();
			for(int i = 0; i < lProductoss.length; i++) {
				lProductoss[i].setCategoria(null);
	...
	public static boolean refresh(appventawebbd.Categoria categoria) throws PersistentException {
		try {
			AppventawebPersistentManager.instance().getSession().refresh(categoria);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(appventawebbd.Categoria categoria) throws PersistentException {
		try {
			AppventawebPersistentManager.instance().getSession().evict(categoria);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
