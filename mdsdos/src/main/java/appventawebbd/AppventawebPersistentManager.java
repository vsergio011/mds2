...
public class AppventawebPersistentManager extends PersistentManager {
	...
	protected void configureMetadataSources(MetadataSources aMetadataSources) {
		...
		aMetadataSources.addAnnotatedClass(appventawebbd.Usuario.class);
		aMetadataSources.addAnnotatedClass(appventawebbd.Pedido.class);
		aMetadataSources.addAnnotatedClass(appventawebbd.Comentario.class);
		aMetadataSources.addAnnotatedClass(appventawebbd.Producto.class);
		aMetadataSources.addAnnotatedClass(appventawebbd.Categoria.class);
		aMetadataSources.addAnnotatedClass(appventawebbd.Mensaje.class);
		aMetadataSources.addAnnotatedClass(appventawebbd.Pendiente.class);
		aMetadataSources.addAnnotatedClass(appventawebbd.Enviado.class);
		aMetadataSources.addAnnotatedClass(appventawebbd.Entregado.class);
		aMetadataSources.addAnnotatedClass(appventawebbd.Oferta.class);
		aMetadataSources.addAnnotatedClass(appventawebbd.Cibernauta.class);
		aMetadataSources.addAnnotatedClass(appventawebbd.Empleado.class);
		aMetadataSources.addAnnotatedClass(appventawebbd.Administrador.class);
		aMetadataSources.addAnnotatedClass(appventawebbd.Encargado.class);
		aMetadataSources.addAnnotatedClass(appventawebbd.Transportista.class);
		aMetadataSources.addAnnotatedClass(appventawebbd.Item.class);
		aMetadataSources.addAnnotatedClass(appventawebbd.Foto.class);
	}
