...
public class ItemDAO {
	...
	public static Item loadItemByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Item) session.load(appventawebbd.Item.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Item getItemByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Item) session.get(appventawebbd.Item.class, new Integer(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Item loadItemByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Item) session.load(appventawebbd.Item.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Item getItemByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Item) session.get(appventawebbd.Item.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryItem(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From appventawebbd.Item as Item");
		if (condition != null)
	...
	public static Item createItem() {
		return new appventawebbd.Item();
	}
	
	public static boolean save(appventawebbd.Item item) throws PersistentException {
		try {
			AppventawebPersistentManager.instance().saveObject(item);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(appventawebbd.Item item) throws PersistentException {
		try {
			AppventawebPersistentManager.instance().deleteObject(item);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(appventawebbd.Item item)throws PersistentException {
		try {
	...
	public static boolean deleteAndDissociate(appventawebbd.Item item, org.orm.PersistentSession session)throws PersistentException {
		try {
			if (item.getPedido() != null) {
				item.getPedido().items.remove(item);
			}
	...
	public static boolean refresh(appventawebbd.Item item) throws PersistentException {
		try {
			AppventawebPersistentManager.instance().getSession().refresh(item);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(appventawebbd.Item item) throws PersistentException {
		try {
			AppventawebPersistentManager.instance().getSession().evict(item);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
