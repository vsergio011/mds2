...
public class ComentarioDAO {
	...
	public static Comentario loadComentarioByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Comentario) session.load(appventawebbd.Comentario.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Comentario getComentarioByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Comentario) session.get(appventawebbd.Comentario.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Comentario loadComentarioByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Comentario) session.load(appventawebbd.Comentario.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Comentario getComentarioByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Comentario) session.get(appventawebbd.Comentario.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryComentario(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From appventawebbd.Comentario as Comentario");
		if (condition != null)
	...
	public static Comentario createComentario() {
		return new appventawebbd.Comentario();
	}
	
	public static boolean save(appventawebbd.Comentario comentario) throws PersistentException {
		try {
			AppventawebPersistentManager.instance().saveObject(comentario);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(appventawebbd.Comentario comentario) throws PersistentException {
		try {
			AppventawebPersistentManager.instance().deleteObject(comentario);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(appventawebbd.Comentario comentario)throws PersistentException {
		try {
			if (comentario.getCibernauta() != null) {
				comentario.getCibernauta().comentario.remove(comentario);
			}
	...
	public static boolean deleteAndDissociate(appventawebbd.Comentario comentario, org.orm.PersistentSession session)throws PersistentException {
		try {
			if (comentario.getCibernauta() != null) {
				comentario.getCibernauta().comentario.remove(comentario);
			}
	...
	public static boolean refresh(appventawebbd.Comentario comentario) throws PersistentException {
		try {
			AppventawebPersistentManager.instance().getSession().refresh(comentario);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(appventawebbd.Comentario comentario) throws PersistentException {
		try {
			AppventawebPersistentManager.instance().getSession().evict(comentario);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
