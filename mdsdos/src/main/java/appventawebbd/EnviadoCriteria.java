...
public class EnviadoCriteria extends AbstractORMCriteria {
	...
	public EnviadoCriteria(Criteria criteria) {
		...
		transportistaEnvioId = new IntegerExpression("transportistaEnvio.", this);
		transportistaEnvio = new AssociationExpression("transportistaEnvio", this);
	}
	...
	public TransportistaCriteria createTransportistaEnvioCriteria() {
		return new TransportistaCriteria(createCriteria("transportistaEnvio"));
	}
