...
<vaadin-vertical-layout style="width: 100%; height: 100%; justify-content: center;" id="vaadinVerticalLayout">
 <vaadin-vertical-layout theme="spacing" style="width: 40%; height: 40%; align-self: center; padding: var(--lumo-space-l); justify-content: center;">
  <label style="font-weight: bold; align-self: center; margin: var(--lumo-space-s);" id="titleLbl">Cambio de contrase�a</label>
  <label style="align-self: center; font-size: 13px; flex-grow: 0; width: 85%;" id="descripcionLabel">Se ha enviado un mensaje a su cuenta de correo con un numero de acceso. Copielo en el siguiente cuadro y pulse continuar: </label>
