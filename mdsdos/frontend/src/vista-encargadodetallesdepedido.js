...
<vaadin-horizontal-layout class="content" style="width: 100%; height: 100%;">
 <vaadin-vertical-layout theme="spacing" style="width: 100%; margin: var(--lumo-space-xl);">
  ...
  <label id="lbId">id: 1212323142134</label>
 ...
 <vaadin-vertical-layout theme="spacing" style="width: 100%; margin: var(--lumo-space-xl);">
  ...
  <vaadin-vertical-layout id="contenedorProductos" style="width: 100%; height: 80%; border:solid; align-items: center; justify-content: flex-start;">
   <button style="width: 100%;">Ejemplo con botones </button>
