...
class VistaEncargadodetallemensaje extends PolymerElement {
...
`;
    ...
    static get is() {
        return 'vista-encargadodetallemensaje';
    }
...
customElements.define(VistaEncargadodetallemensaje.is, VistaEncargadodetallemensaje);
