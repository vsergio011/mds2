...
<vaadin-horizontal-layout class="content" style="width: 100%; height: 100%; border:solid; border-width:1px; padding: var(--lumo-space-xl);" theme="spacing">
 <vaadin-horizontal-layout style="width: 25%; margin: var(--lumo-space-m);">
 ...
 <vaadin-vertical-layout style="width: 25%; height: 100%; align-self: center; justify-content: center; align-items: flex-start;">
 ...
 <vaadin-vertical-layout theme="spacing" style="align-self: center;">
  <label id="precioUnidadLbl" style="width: 100%;">precio</label>
 </vaadin-vertical-layout>
 <vaadin-vertical-layout style="width: 25%; height: 100%; justify-content: center; align-self: center;">
  <vaadin-button id="com,entarBtn" style="align-self: center;">
    Comentar 
  </vaadin-button>
  <vaadin-button id="deleteBtn" style="align-self: center;">
    Eliminar 
  </vaadin-button>
  <vaadin-combo-box id="vaadinComboBox" style="align-self: flex-end;">
    1 
  </vaadin-combo-box>
 </vaadin-vertical-layout>
